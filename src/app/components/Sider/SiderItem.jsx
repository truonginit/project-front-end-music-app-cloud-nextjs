    ...
    return (
        <>
            <li className=" mb-[20px] dark:text-darkModeText">
                <Link 
                    href={href} 
                    className={`flex items-center gap-x-[20px] transition duration-0 ease-in-out ${pathname === href ? "dark:text-darkModeActive" : ""}  hover:dark:text-darkModeActive  hover:duration-1000 dark:text-darkModeText`}
                >
